...
const Database = () => {
    const pokemons = [
        ...
        description:"when viewed trhought a microscope, this pokemon's short, fine, delicate hair can be seen.",
        hp:100,
        atk:100,
        def:100,
        satk:100,
        ...
        description:"it eats iron ore - and sometimes railroad trucks - to build up the steel armor that protects its body.",
        hp:50,
        atk:70,
        def:100,
        satk:40,
